    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-7xl">
            <div className="mb-12 text-center">
                ...
                <div className="mt-2 h-1 w-20 bg-secondary mx-auto rounded-full" />
                <motion.p
                        ...
                        >
                            {items.map((item, index) => (
                                <motion.div
                                    ...
                                    className={`relative overflow-hidden rounded-2xl cursor-pointer shadow-sm border border-border/50 ${item.span}`}
                                ...
                                >
                                    ...
                                    />
                                    <motion.div
                                        className="absolute inset-0 flex flex-col justify-end p-4 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300"
                                    >
